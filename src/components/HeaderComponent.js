          ...
          <div className="container">
            ...
            <Collapse isOpen={this.state.isNavOpen} navbar>
              <Nav navbar>
                ...
                <NavItem><NavLink className="nav-link" to="/aboutus"><span className="fa fa-info fa-lg">&nbsp; About Us</span></NavLink></NavItem>
                <NavItem><NavLink className="nav-link" to="/menu"><span className="fa fa-list fa-lg">&nbsp; Menu</span></NavLink></NavItem>
                <NavItem><NavLink className="nav-link" to="/contactus"><span className="fa fa-address-card fa-lg">&nbsp; Contact Us</span></NavLink></NavItem>
              </Nav>
        ...
        <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
          ...
          <ModalBody>
            <Form onSubmit={this.handleLogin}>
              ...
              <FormGroup check>
                <Label check>
                  <Input type="checkbox" nane="remember"innerRef={input => this.remember = input} />
                  Remember Me
                </Label>
              </FormGroup>
